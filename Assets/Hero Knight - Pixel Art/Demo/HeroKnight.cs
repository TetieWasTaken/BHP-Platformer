...
public class HeroKnight : MonoBehaviour {
    ...
    [SerializeField] GameObject dialogueBoxManager;
    ...
    void Update ()
    {
        ...
        if (cheatMode) {
            // Allow the player to click to teleport
        ...
        //Jump
        else if ((Input.GetKeyDown("space") || Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown("w")) && (m_grounded || m_doubleJump) && !m_rolling)
        {
